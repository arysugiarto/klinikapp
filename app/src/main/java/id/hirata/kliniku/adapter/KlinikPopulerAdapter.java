...
public class KlinikPopulerAdapter extends RecyclerView.Adapter<KlinikPopulerAdapter.MyViewHolder> {
    ...
    public KlinikPopulerAdapter(SearchActivity mContext, List<Klinik> klinikList) {
        this.mContext = mContext;
        this.klinikList = klinikList;
    }

    @Override
    public KlinikPopulerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.klinik_populer_horizontal_item, parent, false);

        return new KlinikPopulerAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final KlinikPopulerAdapter.MyViewHolder holder, int position) {
